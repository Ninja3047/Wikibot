...
class WikiBot:
    wurl = "https://en.wikipedia.org/w/api.php?action=query&format=json \
            &prop=extracts&exchars=420&explaintext&redirects=&titles="
    ...
    def search(self, term):
        try:
            ...
            req.add_header('User-Agent', 'WikiBot/2.0 ([email]) IRC Bot')
